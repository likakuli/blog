...
10:"文字消息设置",
6:"音频消息设置"
},E=8,I=t("pages/media/modules/video_status/video_status.js"),A=5,N=_.inherit({
init:function(t){
this._o={
isNew:!0,
app_id:"",
...
this.initG(),this.initEvent(),this.data=this.initData(),this.renderArticleItem(this._o.index);
},
...
initEvent:function(){
var t=this,e=this._o.ueditor;
e.addListener("hasCoverSetted",function(e,i){
t._o.hasCoverSetted=!!i;
}),e.addListener("isCoverSetted",function(){
return!!t._o.hasCoverSetted;
});
},
initData:function(){
var t=this._o.data,e=this._o.index,r=this._o.cgiData,a=this._o.isOldMaterial,n=c.getLocalKey(e);
for(var s in t)t.hasOwnProperty(s)&&"undefined"!=typeof n[s]&&(n[s]="[object Number]"===Object.prototype.toString.call(n[s])?1*t[s]:"[object String]"===Object.prototype.toString.call(n[s])?t[s]?t[s]+"":"":t[s]);
if(n.file_id=1*n.file_id===0?"":n.file_id+"",n.writerid||(n.authority=0,n.author_status=1),
n.can_reward=1*r.can_use_reward?n.can_reward:0,r&&1==r.can_use_comment){
if(this._o.isNew){
var o=localStorage.getItem("commentStatus_"+wx.data.user_name);
null!==o&&(o=JSON.parse(o),n.need_open_comment=o.need_open_comment,n.only_fans_can_comment=o.only_fans_can_comment,
n.only_fans_days_can_comment=o.only_fans_days_can_comment,n.reply_flag=void 0===o.reply_flag?2===window.wx.acl.product_acl.can_c2c_reply?2:0:o.reply_flag);
}
}else n.need_open_comment=0;
if(0==n.need_open_comment&&(n.only_fans_can_comment=0,n.only_fans_days_can_comment=0,
n.reply_flag=2===window.wx.acl.product_acl.can_c2c_reply?2:0),n.title_tips="第%s篇图文".sprintf(D[e]),
n.cdn_url_back||(n.cdn_url_back=n.cdn_url),8===n.share_page_type&&a&&n.cdn_url&&(this._o.hasCoverSetted=!0),
n.cdn_url?(n.cover=n.cdn_url=n.cdn_url.nogif(),n.cdn_235_1_url||(n.cdn_235_1_url=n.cdn_url),
n.cdn_1_1_url||(n.cdn_1_1_url=n.cdn_url),n.cdn_16_9_url||(n.cdn_16_9_url=n.cdn_url)):n.file_id&&(r&&r.appmsg_data.multi_item&&$.each(r.appmsg_data.multi_item,function(t,e){
e.file_id==n.file_id&&(n.cover=e.cover);
}),n.cover||(n.cover=wx.url("/cgi-bin/getimgdata?mode=large&source=file&fileId=%s".sprintf(n.file_id)))),
n.source_url_checked=n.source_url?1:0,n.advert_info&&n.advert_info.back_transition){
var d=n.advert_info.back_transition;
if("string"==typeof d){
var _=d||"";
_=i.htmlDecode(_),n.advert_info.back_transition=JSON.parse(_);
}
}
if(!n.crop_list||"[object String]"===Object.prototype.toString.call(n.crop_list))try{
n.crop_list=JSON.parse(n.crop_list);
}catch(l){
n.crop_list={
crop_list:[]
};
}
return n.crop_list&&n.crop_list.crop_list||(n.crop_list={
crop_list:[]
}),n=this._o.ueditor.initPluginData(n),5===n.share_page_type&&(t.video_ori_status=3,
n.status=I.getVideoStatus(t)),{
set:function(t,e){
"undefined"!=typeof n[t]&&"undefined"!=typeof e&&(n[t]=e);
},
get:function(t){
return n[t];
},
...
var t=this,e=t.data.getData(),i=t._o.$infoContainer,r=$("#reward_setting_area"),a=e.share_page_type===A&&1===parseInt(e.video_ori_status,10),n=wx.cgiData,s=n.can_use_reward,o=n.totalRewardAccountCnt,d=n.inviteAuthorCnt;
""===e.video_ori_status&&1===e.applyori&&(a=!0),1===e.applyori&&e.writerid&&(a=!0);
var _=$(".js_ori_container");
if(!t._o.data||"EN_SOURCE_REPRINT_STATUS_IN_WHITE_LIST_WITH_SOURCE"!==t._o.data.source_reprint_status&&"EN_SOURCE_REPRINT_STATUS_IN_WHITE_LIST_WITHOUT_SOURCE"!==t._o.data.source_reprint_status?_&&_.find(".js_reward_tips")&&_.find(".js_reward_tips").parent()&&_.find(".js_reward_tips").parent().show():_&&_.find(".js_reward_tips")&&_.find(".js_reward_tips").parent()&&_.find(".js_reward_tips").parent().hide(),
...
var c=t.getRewardErrorText();
e.can_open_reward&&e.can_reward?(c?r.find(".reward_text_setting").addClass("reward_text_error"):r.find(".reward_text_setting").removeClass("reward_text_error"),
...
return u++,"js_pay_preview_filter"===e.className?(m=!0,h=i,e.parentNode.removeChild(e),
!0):void 0;
...
a.data("offset",u),a.find(".js_preview_percent").html(y+"%"),r.find("#js_pay_setting_preview .js_preview_percent").html(y+"%"),
...
0===t?r=$("#ueditor_0").length>0?$("#ueditor_0").contents().find(".js_editor_audio"):[]:7===t&&(r=$(".js_audio_card")),
...
}),0==t.get("need_open_comment"))t.set("only_fans_can_comment",0),t.set("only_fans_days_can_comment",0),
t.set("reply_flag",2===window.wx.acl.product_acl.can_c2c_reply?2:0);else{
t.set("only_fans_can_comment",1*$(".js_comment_setting:checked").val()===1?1:0),
t.set("only_fans_days_can_comment",1*$(".js_comment_setting:checked").val()===2?1:0);
var o=1*$(".js_reply_setting:checked").val();
t.set("reply_flag",0===o?0:o+1);
}
if(1==i.can_use_hyperlink){
var d=t.get("content").match(/<a([^>]*)>(.*?)<\/a>/g);
d&&t.set("link_count",d.length);
}
var _=t.get("cdn_url"),c=t.get("file_id");
if(_)_=_.nogif(),t.set("cdn_url",_),t.set("cover",_);else if(c){
var l,i=this._o.cgiData;
i&&i.appmsg_data&&i.appmsg_data.multi_item&&$.each(i.appmsg_data.multi_item,function(t,e){
e.file_id==c&&(l=e.cover);
}),l||(l=wx.url("/cgi-bin/getimgdata?mode=large&source=file&fileId=%s".sprintf(c))),
t.set("cover",l);
}else t.set("cover","");
t.set("isFirst",0==this.getListItem().index());
var h=e.find("#js_article_tags_area .js_article_tags");
h&&t.set("appmsg_album_info",JSON.stringify({
appmsg_album_infos:JSON.parse(h.data("value")||"[]")
}));
var p=t.get("audio_info");
"string"!=typeof p&&(p=JSON.stringify(p)),t.set("audio_info",p),this.setScrollTop(),
...
i.share_page_type===A?$("#reward_setting_area").find(".reward_text_setting").addClass("reward_text_error"):(this.showErrMsg(t.$dom.find(".js_content_error"),e),
...
var e=this.getArticleType()===A?"简介":"推荐语",i="%n长度不能超过%s字".replace("%n",e).replace("%s",this._o.guideWordlimit);
...
this._o.$infoContainer.find('input[name="can_reward"]').val(1*t.can_reward),this.getArticleType()!==A&&this.renderReward());
},
...
var t=this._o.$infoContainer,e=this.data.getData(),r=e.cover,a=this.getIndex();
e.share_page_type===E&&(r||(r=e.share_imageinfo[0]&&e.share_imageinfo[0].cdn_url),
0===a&&(t.find(".setting-group__cover").addClass("setting-group__cover_normal"),
t.find(".setting-group__cover").removeClass("setting-group__cover_primary")));
var n=t.find(".js_cover_preview");
n.find("img").remove(),r&&(o.isLocalDomain(r)||i.isOuterWhiteDomain(r))?n.show().css("backgroundImage",'url("'+r+'")'):(this._g.$item.removeClass("has_thumb").find(".js_appmsg_thumb").css("backgroundImage",'url("")'),
n.hide(),t.find(".js_cdn_url").val(""),t.find(".js_file_id").val(""),t.find(".js_cdn_url_back").val("")),
...
var e,i,r,a,n=arguments.length<=1||void 0===arguments[1]?!1:arguments[1],s=this._o.$infoContainer,o=t.multiSize,d={
crop_list:[]
};
if(o){
o["16_9"]&&o["16_9"].url&&(e=o["16_9"].url.http2https().nogif()),o["16_9"]&&o["16_9"].file_id&&(i=o["16_9"].file_id),
o["2.35_1"]&&o["2.35_1"].url&&(r=o["2.35_1"].url.http2https().nogif()),o["1_1"]&&o["1_1"].url&&(a=o["1_1"].url.http2https().nogif());
for(var _ in o){
var c=o[_];
d.crop_list.push({
ratio:_,
x1:Math.floor(c.absX1),
y1:Math.floor(c.absY1),
x2:Math.floor(c.absX2),
y2:Math.floor(c.absY2)
});
}
}
var l="";
l=t.url?t.url.http2https().nogif():wx.url("/cgi-bin/getimgdata?mode=large&source=file&fileId=%s".sprintf(t.file_id)),
e||(e=l),i||(i=t.file_id),r||(r=l),a||(a=l);
var h,p=t.oriUrl||l,u=this.getIndex();
if(h=1*u===0?r:a,this.isCurrentArticle()){
var f=new Image;
f.onerror=function(){
s.find(".js_cover_loading").css("visibility","hidden");
},f.onload=function(){
s.find(".js_cover_loading").css("visibility","hidden");
},f.src=h;
var m=s.find(".js_cover_preview");
if(m.show(),m.css("backgroundImage",'url("'+h+'")'),m.find("input.js_file_id").val(i),
m.find("input.js_cdn_url").val(e),m.find("input.js_cdn_url_back").val(p),1*t.coverPic===1&&p){
var g=this._o.ueditor.getUeditor(),v=g.selection.getRange(),w=v.createBookmark(),y=g.body.firstChild;
v.setEndBefore(y),v.setStartBefore(y),g.fireEvent("insertMaterialImg",{
format:t.oriFormat,
src:p
}),v.moveToBookmark(w),v.select(),g.fireEvent("contentchange",!0),g.fireEvent("scrollIntoView",$("#author"),200);
}
s.find(".js_show_cover_pic").val("0"),this._g.$item.find(".js_appmsg_thumb").css("backgroundImage",'url("'+h+'")'),
this._g.$item.addClass("has_thumb"),this.changeCoverPreviewCss(m);
}
...
this.data.set("cdn_url_back",p),this.data.set("show_cover_pic",0),this.data.set("crop_list",d),
n&&8===this.data.get("share_page_type")&&(this._o.hasCoverSetted=!0);
},
renderComment:function(){
var t=this._o.$infoContainer,e=this.data.getData();
t.find(".js_comment").checkbox("checked",0!=e.need_open_comment);
var i=Number(e.only_fans_can_comment),r=Number(e.only_fans_days_can_comment),a=Number(e.reply_flag),n=$(".js_comment_setting").checkbox("checked",!1),s=$(".js_reply_setting").checkbox("checked",!1),o=void 0,d=void 0;
o=1===i?1:1===r?2:0;
var _=n.eq(o).checkbox("checked",!0).data("label");
switch(a){
case 0:
d=0;
break;
...
default:
d=2===window.wx.acl.product_acl.can_c2c_reply?1:0;
}
var c=s.eq(d).checkbox("checked",!0).data("label");
0==e.need_open_comment?($("#js_comment_area").find(".comment_setting").hide(),$("#js_comment_area").find(".js_comment_allow_click").removeClass("open")):($("#js_comment_area").find(".comment_setting").show(),
$("#js_comment_area").find(".js_comment_allow_click").addClass("open"));
var l=void 0;
l=2===window.wx.acl.product_acl.can_c2c_reply?o===d-1?_+"可留言和回复":_+"可留言，"+c+"可回复":_+"可留言",
t.find("#js_comment_area .comment_setting").html(l);
},
...
var t=this._o.$infoContainer,i=this._o.$infoContainer.find(".js_reward_container"),a=this.data.get("author"),n=this.data.get("can_reward"),s=this.data.get("can_open_reward"),o=this.data.get("writerid"),d=this.data.get("authority"),_=this.data.get("author_status"),c=this.data.get("copyright_type"),l=this.data.get("is_share_copyright"),h=t.find(".js_author_container"),p=t.find("input.js_author"),u=t.find(".js_reward_tips");
...
h.addClass("author_status_warn"),p.siblings(".js_author_warn").remove(),$(f).insertBefore(p),
r.init({
$container:h
});
}else h.removeClass("author_status_warn"),p.siblings(".js_author_warn").remove();
...
i.find(".js_no_reward_list").hide(),i.find(".js_reward_error").hide(),u.text("已开启")):(m?i.find(".js_reward_error").text(m).show():i.find(".js_reward_error").hide(),
i.find(".js_reward_preview_list").hide(),i.find(".js_no_reward_list").show(),u.text("未开启"));
},
...
content:"",
close:function(){
$("#js_show_text_tip").hide(),n.EventType=2,u.report(20426,n);
},
cancel:function(){
$("#js_show_text_tip").hide(),n.EventType=4,u.report(20426,n);
},
confirm:function(){
$("#js_show_text_tip").hide(),n.EventType=3,u.report(20426,n);
}
...
if(t.share_page_type===A&&wx.cgiData.canUseVideoPaster)if(e.show(),t.share_videoinfo[0].play_length>=b&&(t.isMyMpVideo||t.is_my_mp_video))if(e.removeClass("video-disabled"),
...
if(t&&t.share_page_type===A)if(e.show(),!o||-1!==[6,7].indexOf(1*t.status)&&1*t.video_ori_status===2)!function(){
...
}();else switch(e.removeClass("video-disabled"),i.attr("disabled",!1),0===d?(i.checkbox("checked",!1),
r.hide(),n.removeClass("open")):(i.checkbox("checked",!0),r.show(),n.addClass("open")),
d){
case 2:
...
var e=(this._o.ueditor,this.data.getData()),i=this._o.$infoContainer.find("#js_article_tags_area").show(),r=i.find(".js_article_tags"),n=r.parent(),s=n.find(".js_article_tags_content"),o=(2===wx.cgiData.realname_type||9===wx.cgiData.realname_type,
11===wx.cgiData.customer_type,wx.cgiData.is_ban_album),d=i.find(".read-more__icon__more");
if(0===n.find("#tipsIcon").length){
var _;
!function(){
_='<span id="tipsIcon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 22 22" style="position:relative; top:2px; cursor: default;"><path fill-opacity=".5" fill-rule="evenodd" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-1.2a8.8 8.8 0 1 0 0-17.6 8.8 8.8 0 0 0 0 17.6zM9 9.707C9.077 8.2 10.081 7 12.042 7 13.8 7 15 8.088 15 9.526c0 1.095-.565 1.87-1.458 2.407-.886.523-1.137.914-1.137 1.646v.454h-1.221v-.642c-.007-.921.44-1.55 1.395-2.121.81-.496 1.123-.935 1.123-1.682 0-.865-.67-1.5-1.709-1.5-1.053 0-1.723.621-1.8 1.619H9zm2.798 7.507a.786.786 0 0 1-.796-.795c0-.454.35-.796.796-.796.453 0 .795.342.795.796a.782.782 0 0 1-.795.795z"></path></svg></span>',
n.append(_);
var t=new a({
dom:n.find("#tipsIcon"),
content:'<div id=\'popoverTips\'><p>话题标签可以被用户订阅，也可能会被推荐。在文章中，话题将展现在标题下方。</p><p><img style="width: 100%;" src="https://res.wx.qq.com/a/fed_upload/61b65b23-253c-420c-8116-cb510c46c722/3.png"/></p></div>',
place:"top",
width:290,
defaultOpen:!1,
onShow:function(){
...
n.on("mouseover","#tipsIcon",function(){
t.show();
}),n.on("mouseleave","#tipsIcon",function(){
t.hide();
}),n.find("#tipsIcon").click(function(t){
t.preventDefault(),t.stopPropagation();
}),n.find("#tipsIcon").hide();
}();
}
var c=function(t){
var e=arguments.length<=1||void 0===arguments[1]?"":arguments[1],i=arguments.length<=2||void 0===arguments[2]?!1:arguments[2];
t?(r.prop("checked",!0),n.addClass("selected")):(r.prop("checked",!1),n.removeClass("selected")),
i?(r.prop("disabled",!0),n.addClass("disabled")):(r.prop("disabled",!1),n.removeClass("disabled")),
s.text(e);
},l=!0;
if(o)!function(){
c(!1,"",!0),i.css("color","#8D8D8D"),d.css("background-image","url(\"data:image/svg+xml;charset=UTF-8,%3csvg width='16' height='16' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M10.317 8.05l.178.13-3.386 4.66-1.165-.846L8.809 8.05 5.944 4.106l1.165-.846 3.386 4.66-.178.13z' fill='%23000' fill-opacity='.4' fill-rule='evenodd'/%3e%3c/svg%3e\")");
var t=new a({
dom:i.find(".js_article_tags_label"),
content:"因不当使用话题标签能力，暂无法添加。",
place:"top",
width:290,
defaultOpen:!1,
onShow:function(){
...
i.on("mouseover",".js_article_tags_label",function(){
t.show();
}),i.on("mouseleave",".js_article_tags_label",function(){
t.hide();
});
}();else if(l){
var h=void 0;
if(t.useData){
var p=e.appmsg_album_info;
"string"==typeof e.appmsg_album_info&&(p=JSON.parse(e.appmsg_album_info));
var u=p.appmsg_album_infos;
h=u&&u.map(function(t){
var e=t.title;
return e;
})||[],r.data("value",JSON.stringify(u));
}else h=(JSON.parse(r.data("value"))||[]).map(function(t){
var e=t.title;
return e;
});
$("#popoverTips").html(5===e.share_page_type?'<p>话题标签可以被用户订阅，也可能会被推荐。在视频消息中，话题将展现在视频下方。</p><p><img style="width: 100%;" src="https://res.wx.qq.com/op_res/bRfJyHqpQ_hVsB1s9ZzchBaPzydv3ClVMlOl-93NtZN8S-5GxiSkAd3UPyYnS4SfVHC3AMApPadZo50800wZRg"/></p>':'<p>话题标签可以被用户订阅，也可能会被推荐。在文章中，话题将展现在标题下方。</p><p><img style="width: 100%;" src="https://res.wx.qq.com/a/fed_upload/61b65b23-253c-420c-8116-cb510c46c722/3.png"/></p>'),
h.length?!function(){
var t=[];
h.forEach(function(e){
t.push("#"+e);
}),c(!0,t.join("，")),n.find("#tipsIcon").hide();
}():(c(!1,"话题标签可被推荐和订阅"),n.find("#tipsIcon").show());
}else r.data("value","[]"),c(!1,"非原创文章不可添加话题。什么是话题",!0),n.find("#tipsIcon").show();
}
},
