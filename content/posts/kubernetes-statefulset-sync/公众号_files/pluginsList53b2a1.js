...
var a=!1;
a=this._hasMaterial(),t.list=a&&[a],t._initArticleList(!1);
}else t.list=!1,t._initArticleList(!1);
t._bindEvent();
},
...
var e=arguments.length<=0||void 0===arguments[0]?!0:arguments[0],t=this;
if(t.list){
var i=t.list.length;
$.each(t.list,function(r,a){
t.add({
data:a,
isOldMaterial:e,
isNew:!1
...
}),wx.cgiData.bizmediaid?(t.select({
idx:wx.cgiData.idx,
doNotHideErr:!1,
doNotScroll:!0,
isNewCreate:!1,
markInited:!0
}),$("#nav").text(wx.cgiData.appmsg_data.history_time?"正在查看历史版本："+h.unix(wx.cgiData.appmsg_data.update_time).format("YYYY-MM-DD HH:mm:ss")+"由"+(wx.cgiData.appmsg_data.operator_name||"未知")+"保存":"正在查看历史版本")):t.select({
idx:0,
doNotHideErr:!1,
doNotScroll:!0,
isNewCreate:!1,
...
}else if(1!=t.isshare)if("5"==t.createType||"7"==t.createType||"8"==t.createType||"9"==t.createType)t.createArticle({
type:t.createType,
onCancel:function(){
t.add({
isNew:!0
...
t._g.hasInitArticleData=!0,t._updateTitleTips(),t.lastData=t._hasAppmsgType()?!1:t.getData()||!1,
t.hasConfirmed=!1,"10"!==t.createType&&(O.$actionBtn=$(template.render("tpl_article_action",{})).appendTo("body")),
t._renderReadOnly(),t._warnDraft(),t._initDraftSyn(),t.renderCreateBtn();
},
...
var a=new Image;
a.src="/cgi-bin/reportmaterialoper?oper=2&token="+wx.data.t,new S({
link:1,
onOK:function(r){
if(r){
var a=i[e]({
...
getSelfCheckData:function(){
var e=this,t=window.wx.cgiData,i=t.bizmediaid,r=t.idx,a=this.getPostData(!1,!0),n={
appmsgid:e.app_id,
bizmediaid:i,
idx:r,
updateautocheck:1,
...
var r=e.list[i],a=void 0;
r.export_id?a=t.querySelector("mpvideosnap[data-id='"+r.export_id+"']"):r.notice_id&&(a=t.querySelector("mpvideosnap[data-noticeid='"+r.notice_id+"']")),
a&&(65211===r.err_code?this.addVideoSnapStatus(a,"该视频号动态不可用"):65212===r.err_code?this.addVideoSnapStatus(a,"该视频号动态不可用"):65213===r.err_code?this.addVideoSnapStatus(a,"新发表动态暂时无法引用，请稍后重试"):65214===r.err_code&&this.addVideoSnapStatus(a,"预约已失效"));
}
},
addCardStatus:function(e,t){
if(e){
var i=e.querySelector(".js_msg_container");
i&&(i.style.display="flex");
var r=e.querySelector(".js_msg_text");
r&&(r.innerHTML=t);
var a=e.querySelector(".js_card");
a&&a.classList.add("wx_card_disabled");
}
},
changeProfileCardStatus:function(e){
var t=this.editor.ueditor&&this.editor.ueditor.document;
if(e&&e.err_num)for(var i=0;i<e.err_num;i++){
var r=e.list[i],a=void 0;
r.fakeid&&(a=t.querySelector("mpprofile[data-id='"+r.fakeid+"']")),a&&64564===r.err_code&&this.addCardStatus(a,"该公众号已被封禁");
}
},
...
t(i,n),m.data_seq=i.data_seq+"",m.update(i.filter_content_html,n),m.lastData=m.getData()||!1,
m.lastData=m.getData()||!1,m.draft&&(m.draft.clear(),m.draft._updateAppid(m.app_id,m.data_seq)),
m._checkExternalLink(n);
},function(t,r,s,d){
...
case 203009:
p.err("保存失败，读者讨论功能已暂停内测，请删除读者讨论插件后保存");
break;
...
case 64522:
p.err("文章插入公众号名片数超出上限");
break;

case 64564:
p.err("含有不能被插入的公众号，请删除后重试"),m.changeProfileCardStatus(d.biz_card_errmsg);
break;
...
case 64566:
p.err("该帐号暂时无法发送含有公众号卡片的内容，请删除后重试");
break;

case 64568:
p.err("含有小程序卡片的封面图域名不符合规范，请删除或更换");
break;
...
"use strict";
function e(e){
var r=document.getElementById("js_plugins_list");
if(!r||!e)return!1;
for(var i="",n=0,s=e.length;s>n;n++){
var o=e[n],d=t[o.id]||"js_editor_"+o.id;
i+='<li class="tpl_item" id="'+d+'" data-id="'+o.id+'">'+o.name+"</li>\n";
}
return r.innerHTML=i+r.innerHTML,!0;
}
function r(e){
if(!e)return{};
for(var r={},i=0,n=e.length;n>i;i++){
var s=e[i],o=t[s.id]||"js_editor_"+s.id;
r[s.id]=_extends({},s,{
domId:o,
index:i
});
...
16:"js_editor_insertProfile",
15:"js_editor_insertSubNotify"
};
return{
getEditorPluginsMap:r,
