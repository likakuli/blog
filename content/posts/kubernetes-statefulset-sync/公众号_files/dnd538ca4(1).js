...
define("3rd/webuploader/widgets/widget.js",["3rd/webuploader/base.js","3rd/webuploader/uploader.js"],function(e,n,t){var h=e("3rd/webuploader/base.js"),i=e("3rd/webuploader/uploader.js"),l=h.$,o=i.prototype._init,r=i.prototype.destroy,f={},s=[]
...
return t&&e in t&&t[e]in this&&l.isFunction(this[t[e]])?this[t[e]].apply(this,n):f},request:function(){return this.owner.request.apply(this.owner,arguments)}}),l.extend(i.prototype,{_init:function(){var t=this,i=t._widgets=[],r=t.options.disableWidgets||""
return l.each(s,function(e,n){r&&~r.indexOf(n._name)||i.push(new n(t))}),o.apply(t,arguments)},request:function(e,n,t){var i,r,o,s=0,p=this._widgets,u=p&&p.length,a=[],d=[]
for(n=function(e){if(e){var n=e.length,t=l.type(e)
return 1===e.nodeType&&n||("array"===t||"function"!==t&&"string"!==t&&(0===n||"number"==typeof n&&0<n&&n-1 in e))}}(n)?n:[n];s<u;s++)(i=p[s].invoke(e,n))!==f&&(h.isPromise(i)?d.push(i):a.push(i))
return t||d.length?(r=h.when.apply(h,d))[o=r.pipe?"pipe":"then"](function(){var e=h.Deferred(),n=arguments
return 1===n.length&&(n=n[0]),setTimeout(function(){e.resolve(n)},1),e.promise()})[t?o:"done"](t||h.noop):a[0]},destroy:function(){r.apply(this,arguments),this._widgets=null}}),i.register=p.register=function(e,n){var t,i={init:"init",destroy:"destroy",name:"anonymous"}
return 1===arguments.length?(n=e,l.each(n,function(e){"_"!==e[0]&&"name"!==e?i[e.replace(/[A-Z]/g,"-$&").toLowerCase()]=e:"name"===e&&(i.name=n.name)})):i=l.extend(i,e),n.responseMap=i,(t=h.inherits(p,n))._name=i.name,s.push(t),t},i.unRegister=p.unRegister=function(e){if(e&&"anonymous"!==e)for(var n=s.length;n--;)s[n]._name===e&&s.splice(n,1)},p})
