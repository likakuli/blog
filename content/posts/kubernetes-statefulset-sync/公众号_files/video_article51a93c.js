...
});define("common/wx/top.js",["tpl/top.html.js"],function(e,a,t){
"use strict";
function i(e,a,t){
return this.dom=$(e),this.dom.addClass("title_tab"),a&&"string"==typeof a&&(a=[{
name:"",
url:"javascript:;",
className:"selected"
}]),$.each(a,function(e,a){
...
data:a
})),t&&t.render&&"function"==typeof t.render?$.each(this.dom.find("li"),function(e,i){
t.render.apply($(i),[a[e],t&&t.data]);
}):this.dom.html(template.compile(n)({
data:a
...
1e3*window.wx.data.time>new Date(2020,0,15,0,0,0).getTime();
i.DATA={
setting:[{
id:"info",
name:"帐号详情",
...
"meeting"==e.id&&15!=a.role&&this.remove();
},
message:function(e,a){
"search"!=e.id||a&&"search"==a.action||this.remove();
},
assistant:function(e,a){
"warning"!=e.id||a&&0!=a.have_service_package||this.remove();
},
reward:function(e,a){
"invite"!=e.id||a&&0!=a.invite_authority||this.remove();
}
},t.exports=i;
});!function(n){
"use strict";
...
});define("media/image_article.js",["tpl/media/appmsg_edit/image_article_content_9.html.js","media/base_article.js","biz_common/jquery.validate.js","common/wx/mpEditor/common/eventbus.js","common/wx/media/img9.js"],function(t){
"use strict";
var e=t("tpl/media/appmsg_edit/image_article_content_9.html.js"),i=t("media/base_article.js"),a=(t("biz_common/jquery.validate.js"),
t("common/wx/mpEditor/common/eventbus.js")),n=t("common/wx/media/img9.js"),r=i.inherit({
init:function(){
this.initTextEditorEnv();
},
initData:function(){
var t=this,e=i.prototype.initData.call(this);
...
setTitle:function(t){
var e=t.get("guide_words")||"";
t.set("title",e||"分享图片");
},
setShareImageid:function(t){
for(var e=t.get("share_imageinfo")||[],i=[],a=0;a<e.length;a++)i.push(e[a].file_id);
t.set("share_imageid",i.join(","));
},
getImageWh:function(){
var t=this.data.get("share_imageinfo");
if(t&&0!=t.length)for(var e=0;e<t.length;e++){
var i=t[e];
!i.cdn_url||i.height&&i.width||!function(t,e,i){
var a=new window.Image;
a.onload=function(){
var e=this.naturalWidth||this.width||0,i=this.naturalHeight||this.height||0;
t.setImageWh(this.src,e,i);
},a.src=i;
}(this,e,i.cdn_url);
}
},
setImageWh:function(t,e,i){
if(t&&e&&i){
var a=this.data.get("share_imageinfo");
if(a&&a.length>0){
for(var n=0;n<a.length;n++){
var r=a[n];
r.cdn_url===t&&(r.width=e,r.height=i);
}
...
$dom:this._o.$infoContainer,
strict:!1
},i=JSON.parse(t.share_imageinfo);
if(i&&i.list&&i.list.length>0)e=this.validateGuideWords(e);else{
var a=this._o.$infoContainer;
this.showErrMsg(a.find(".js_content_error"),"请先上传图片，再点击保存按钮。"),e.viewClass=".js_content_error",
e.isValid=!1,this.addValidateReport(127648,29,1);
}
...
wx.cgiData.can_use_comment||a.find("#article_setting_area2").hide();
var r=this.data.getData().share_imageinfo;
r=r.map(function(t){
return t.url=t.cdn_url?t.cdn_url:"/cgi-bin/getimgdata?token="+wx.data.t+"&msgid="+r.msgid+"&mode=small&source="+r.source+"&fileId="+r.file_id+"&ow="+~r.fakeid,
t;
}),r.container="#reprint_article_main",r.isappend=!1,new n(r,function(i){
i=i.map(function(t){
return t.cdn_url=t.url,t;
}),console.info(i),t.data.set("share_imageinfo",i),t.data.get("cover")&&e.fireEvent("isCoverSetted")||t.coverChange(i&&i.length>0?{
url:i[0].cdn_url,
file_id:"",
oriUrl:i[0].cdn_url,
oriFormat:"",
...
display:"none"
}),e.fireEvent("setCoverDescriptionStatus",{
status:!0,
text:"封面预览"
...
onOk:function(i){
var a=i.data;
t.data.set("share_imageinfo",a.share_imageinfo),t.data.set("cdn_url",a.cdn_url),
t.setTitle(t.data),t.setShareImageid(t.data),t.isCurrentArticle()&&t.renderSharePreview({
tpl:e
}),t.coverChange({
url:a.cdn_url,
file_id:"",
...
title:t.data.get("title")
}),t.getImageWh();
}
});
},
getAllImgData:function(){
return this.data.get("share_imageinfo");
}
});
return r.hideDialog=function(t){
a.fireEvent("hideImageDialog",t);
},r.showDialog=function(t){
...
if(!e)return void t.onCancel();
var i=[];
if(e&&e.length>0)for(var a=0;a<e.length;a++)i.push({
file_id:e[a].fileId,
cdn_url:e[a].url,
width:"",
height:""
...
case 2:
$("#vTxt").html("视频审核不通过，请更换素材或前往<a href='/cgi-bin/appmsg?begin=0&count=10&action=list_video&type=15' target='_blank'>素材库</a>查看详情");
break;
...
case 10:
$("#vTxt").html("视频已被删除，请更换素材或前往<a href='/cgi-bin/appmsg?begin=0&count=10&action=list_video&type=15' target='_blank'>素材库</a>查看详情");
break;
...
var t=e("common/wx/media/videoUtils.js"),o=e("common/wx/mpEditor/common/eventbus.js"),a=e("tpl/media/appmsg_edit/video_article_content.html.js"),s=e("media/base_article.js"),d=e("biz_common/jquery.validate.js"),r=e("biz_web/lib/store.js"),n=e("common/wx/const.js"),_=e("media/common.js"),l=(d.rules,
...
initData:function(){
var e=s.prototype.initData.call(this);
...
s.prototype.render.call(this),this.setShowEmotionNLinkNWeapp(!0);
this._o.$infoContainer;
...
t||(this.showToolbar(),this.enableToolbar()),this.setTextEditorWordlimit(h),s.prototype.renderArticleTags.call(this,{
useData:!0
}),this._hasRendered=!0;
var o=this.data.getData(),d=l.getVideoStatus(o);
(0===d||4==d||-1==d)&&l.rollStatus(o.video_id,i,u);
},
destroy:function(){
s.prototype.destroy.call(this),this._hasRendered&&(this.setShowEmotionNLinkNWeapp(!1),
...
s.prototype.updateTitleInputCounter.call(this,n.videoTitleMaxLen);
}
});
