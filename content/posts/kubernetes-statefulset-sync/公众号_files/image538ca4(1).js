...
for(r=(~(i=e.split(","))[0].indexOf("base64")?atob:decodeURIComponent)(i[1]),n=new ArrayBuffer(r.length),t=new Uint8Array(n),o=0;o<r.length;o++)t[o]=r.charCodeAt(o)
return a=i[0].split(":")[1].split(";")[0],this.arrayBufferToBlob(n,a)},dataURL2ArrayBuffer:function(e){var r,t,n,o
for(r=(~(o=e.split(","))[0].indexOf("base64")?atob:decodeURIComponent)(o[1]),t=new Uint8Array(r.length),n=0;n<r.length;n++)t[n]=r.charCodeAt(n)
...
function C(t,e,a){var i,r,n=document.createElement("canvas"),s=n.getContext("2d"),o=0,h=a,c=a
for(n.width=1,n.height=a,s.drawImage(t,0,0),i=s.getImageData(0,0,1,a).data;o<c;)0===i[4*(c-1)+3]?h=c:o=c,c=h+o>>1
return 0==(r=c/a)?1:r}if(7<=i.os.ios)return function(t,e,a,i,r,n){var s=e.naturalWidth,o=e.naturalHeight,h=C(e,0,o)
return t.getContext("2d").drawImage(e,0,0,s*h,o*h,a,i,r,n)}
return function(t,e,a,i,r,n){var s,o,h,c,l,d,g,m,u,f,_,p=e.naturalWidth,v=e.naturalHeight,w=t.getContext("2d"),b=1048576<(_=(m=e).naturalWidth)*m.naturalHeight&&((u=document.createElement("canvas")).width=u.height=1,(f=u.getContext("2d")).drawImage(m,1-_,0),0===f.getImageData(0,0,1,1).data[3]),y="image/jpeg"===this.type,A=1024,I=0,j=0
for(b&&(p/=2,v/=2),w.save(),(s=document.createElement("canvas")).width=s.height=A,o=s.getContext("2d"),h=y?C(e,0,v):1,c=Math.ceil(A*r/p),l=Math.ceil(A*n/v/h);I<v;){for(g=d=0;d<p;)o.clearRect(0,0,A,A),o.drawImage(e,-d,-I),w.drawImage(s,0,0,A,A,a+g,i+j,c,l),d+=A,g+=c
I+=A,j+=l}w.restore(),s=o=null}}()})})
