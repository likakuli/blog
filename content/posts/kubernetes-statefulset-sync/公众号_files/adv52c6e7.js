...
"use strict";
var t=(e("3rd/editor/common/domUtils.js"),e("3rd/editor/plugin/basePlugin.js")),r=e("common/wx/mpEditor/common/eventbus.js"),a=e("3rd/editor/common/no_editable.js"),n=e("common/wx/Tips.js"),i=e("tpl/mpEditor/plugin/search.html.js"),o={
...
t&&(a=t);
}),r.fireEvent("showInsertSearchDialog",{
...
r.find(o.saveTag).remove(),e=r.html();
}
...
}else n.hasClass(o.queryCardClass)&&(a.e.offsetX<n[0].clientWidth/2?t.editor.getSelectionRange().setStartBefore(a.unEditableDom).setEndBefore(a.unEditableDom).select():t.editor.getSelectionRange().setStartAfter(a.unEditableDom).setEndAfter(a.unEditableDom).select());
}
});
},
...
filterPasteRules:function(){
var e;
return e={},_defineProperty(e,o.saveTag,function(e){
e.parentNode.removeChild(e);
}),_defineProperty(e,o.cardTag,function(e){
var t=e.getAttr("class");
t&&t.indexOf(o.queryCardClass)>-1&&e.parentNode.removeChild(e);
}),_defineProperty(e,"span",function(e){
var t=e.getAttr("class");
t&&t.indexOf(o.wapClass)>-1&&e.parentNode.removeChild(e);
}),e;
},
...
keywords:e
}),"</"+o.cardTag+"></"+o.cardTag+">"].join(""),r=$("<div></div>").html(t);
return a.setDisable({
dom:r[0].firstChild.firstChild
}),r.html();
},
insertCard:function(){
var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];
...
var r=$(t),n=r.replaceTagName(o.cardTag).addClass(o.queryCardClass+" "+o.frameClass),i=JSON.parse(decodeURIComponent(n.attr("data-keywords")||""));
n.html(s({
keywords:i
})),a.setDisable({
dom:n[0]
...
filterPasteRules:function(){
var e;
return e={},_defineProperty(e,d.saveTag,function(e){
e.parentNode.removeChild(e);
}),_defineProperty(e,d.cardTag,function(e){
var t=e.getAttr("class");
t&&(t.indexOf("js_wap_redpacketcover")>-1||t.indexOf(d.queryCardClass)>-1)&&e.parentNode.removeChild(e);
}),e;
},
...
var g=null;
a&&1*a.appmsg_idx===1*t._g.curSeq&&(g=a);
var l=t.setError({
tagName:d.cardTag,
$dom:$(this.body),
data:c,
...
!u&&g&&l&&l.$focusDom&&l.$focusDom.length>0&&(u=l.$focusDom);
}else if(m&&m[i]){
var v=$("<div></div>").html(m[i].data.get("content"));
t.setError({
tagName:d.saveTag,
$dom:v,
data:c
}),m[i].data.set("content",v.html());
}
}
if(a)if(u)this.fireEvent("scrollIntoView",u);else{
...
var p=(e("common/wx/dialog.js"),e("common/wx/Cgi.js")),f=e("common/wx/mpEditor/common/eventbus.js"),m=e("common/wx/media/cpsTemplateDialog.js"),h=e("common/wx/media/cpsUtils.js"),g=e("common/wx/mpEditor/utils.js"),v=e("tpl/mpEditor/plugin/cps_template_popup.html.js"),C=e("common/wx/Tips.js"),y=e("biz_web/lib/store.js"),_={
...
},function(){}),void C.err("最多插入%s个商品".sprintf(_.maxLen))):void f.fireEvent("showCpsDialog",{
...
iframe:function(e){
var t=e.getAttr("class");
t&&t.indexOf(_.className)>-1&&e.parentNode.removeChild(e);
},
"-":"mpcps",
section:function(e){
var t=e.getAttr("class"),i=t&&t.indexOf(h.appmsgContainerClass)>-1,r=t&&t.indexOf(h.appmsgProductErrClass)>-1;
(!e.children.length&&!e.getAttr("style")||i||r)&&e.parentNode.removeChild(e);
},
div:function(e){
var t=e.getAttr("class"),i=t&&t.indexOf(h.appmsgLoopClass)>-1;
...
var r=y.get(_.cacheProductKey)||{},a=[];
r.color&&(a=r.color||[]);
...
r.color=a,y.set(_.cacheProductKey,r)),this.changeProductColor(t,i),!0;
}
return!1;
},
...
if(t){
t.loop=1;
var i=y.get(_.cacheProductKey)||{};
i.templateId=e.templateId,y.set(_.cacheProductKey,i),_.curTemplateId=e.templateId;
var r=[],a=[],o=[],n=[];
...
var a=C;
g[a]=[];
for(var y=v[C].ratio,n=s+y,I=m[s],T=m[n];T&&o(I,T,a)===!0;)g[a].push(T),I=T,n+=y,
T=m[n];
}
...
var u=e?c.getPreviewPhoneWidth():i,f=1*t.data("ratio");
f=f?r(f):g.ratio;
var l=Math.round(u/f);
e?t.css({
width:u,
height:l
}):t.removeAttr("style"),e===!0?(t.attr("width",u),t.attr("height","auto"),t.attr("src",c.getPlayurlByVid(v,t.attr("data-mpvid")?1:0,u,"auto",!0))):(t.attr("width",u),
...
t("common/wx/popup.js");
var m=10,v="每篇图文最多添加十个视频",c=(t("biz_common/utils/url/parse.js"),t("common/wx/media/videoUtils.js")),u=t("common/wx/dialog.js"),f=t("common/wx/Tips.js"),l=t("common/wx/getVinfo.js"),h=t("common/wx/mpEditor/common/eventbus.js"),p=(t("common/wx/Cgi.js"),
...
return i.getIframeLen()+a>g.maxLength?(f.err(v),r.html="",!0):void(r.html=n.html());
...
var i=578;
return this.editor.getDocument()&&(i=$(this.editor.getDocument().body).width()),
d(t,e,i);
},
...
if(!r)return!1;
var m=$(r.getDocument()).find(c),l=m.attr("data-category_id_list"),p=m.length,_=p>=d,u=$(".js_appmsg_item.current").data("insertadmode")===a.auto,f="block"===$(".appmsg_edit_ad_preview").css("display"),h=_?d:u?s:1;
return $("#js_pay_setting_area .js_pay_setting_radio").eq(1).parent().hasClass("selected")?(n.err("付费图文不可插入广告"),
!1):(_||u||f)&&!t?(n.err(u?"已插入智能插入文中广告，无法继续插入其他广告，可在编辑器底部进行修改":f?"已插入互选广告，无法继续插入其他广告":"每篇图文消息只可插入"+h+"个广告卡片"),
!1):wx.cgiData.has_ad?void new i({
showStep2:t,
articleAdCount:p,
insertAdMode:p?a.op:void 0,
cpc_edit_data:p?{
...
iframe:function(t){
var e=t.getAttr("class");
e&&e.indexOf("js_cpc_area")>-1&&t.parentNode.removeChild(t);
}
};
},
...
if(-1!==n.indexOf(s)){
for(var l,p=n.split(s),_=[],u=0;u<p.length;u++)u&&(p[u]="<mpcpc "+p[u]),u<p.length-1&&(p[u]+=">"),
_.push(r.getHtmlText(p[u]).length>=d);
return l=-1===_.indexOf(!1),setTimeout(function(){
for(var t,e,n=!0,r=$(i.editor.getDocument()).find(c),o=0;o<r.length;o++){
t=[];
var a=r[o];
if(_[o]||(t.push((o?"距离前一个广告卡片未满":"广告卡片前未满")+d+"个字符"),i.editor.fireEvent("reportAddNum",127648,33,1)),
_[o+1]||(t.push((o!==r.length-1?"距离下一个广告卡片未满":"广告卡片后未满")+d+"个字符"),i.editor.fireEvent("reportAddNum",127648,34,1)),
a){
...
var f;
try{
f=JSON.parse(m.sections);
}catch(h){
return!0;
}
for(var g=!1,v=0;v<f.length;v++)if(f[v].ad_available)return g=!0,!0;
