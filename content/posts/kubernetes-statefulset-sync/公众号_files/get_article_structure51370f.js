...
case 64503:
e._dom.$dialogContent.addClass("with_qrcheck"),e._dom.$failWithoutAddAccount.show();
break;

case 200105:
e._showError("请确认该微信号是否关注公众号");
break;

default:
e._showError(t.word,!0);
}
e._dom.$btn.disable(),e._g.isChecking=!1;
}
},l={
appmsgid:i.appmsgid,
AppMsgId:i.AppMsgId
...
token:i.token,
nickname:i.nickname,
previewTips:window.wx.cgiData.previewDialogTips
})).popup({
title:"发送预览",
...
var o=this;
e._hideError();
var d=s.accountList.concat(),u=a.$wxnameInput.val();
if(u.length&&d.push(u),0==d.length)return a.$errTips.text("请输入预览的帐号").show(),!0;
...
var _=function(){
e.checkDialogAlive()&&(c.suc("成功发送预览到目标手机微信"),setTimeout(function(){
a.$btn.btn(!0);
...
})||"",n.appmsg.sendPreview(l,_,r)):n.appmsg.preview(!0,10,l,_,r):t.preview({
postData:l,
onSuccess:_,
onError:r
}),!0;
...
i.$btn=n.find(".btn_primary>.js_btn"),i.$errTips=n.find(".jsAccountFail"),i.$failWithoutAddAccount=n.find(".jsFailWithoutAddAccount"),
i.$wxnameInput.on("keyup",function(n){
var i="which"in n?n.which:n.keyCode,c=n.target.value,s=$.trim(c);
switch(e._hideError(),e._dom.$btn.enable(),1*i){
case 13:
...
var o=$(n.prevObject[1]).css({
zIndex:9998
}).find("iframe")[0];
o&&o.contentWindow&&$(o.contentWindow.document.getElementsByTagName("body")[0]).click(e._hideRecentlyContainer),
i.$recentlyList.click(function(n){
var i=$(n.target);
i.hasClass("js_add")?t.accountList.length<t.accountLimit?e._addAccount(i.data("value"),!0):c.err("最多添加%s个微信号".sprintf(t.accountLimit)):e._delAccount(i.data("index"));
...
_addAccount:function(e,t){
var i=this,s=i._g,o=i._dom,a=i._g.accountList;
if(-1===a.indexOf(e)){
if(s.isChecking)return;
s.isChecking=!0,n.appmsg.preview(!0,10,{
only_check:1,
is_preview:1,
...
a.push(e),i._renderAccountList(),i._renderRecentlyList(),o.$wxnameInput.val(""),
s.isEmpty=!0,s.isChecking=!1,a.length>=s.accountLimit?i._disableInput():o.$wxnameInput[0].focus();
},function(n){
t&&o.$wxnameInput.val(e),i._error(n);
});
}else c.err("已经添加该微信号");
},
...
this._dom.$failWithoutAddAccount.hide();
},
...
for(var g=d.childNodes,f=g.length-1;f>=0;f--)t.push(g[f]);
}
return{
wholeText:r,
wholeTextColor:n,
...
for(var b=Date.now(),y=0;l>y;y++){
var C,S=n[y].parentNode,k=d[y],T=k.text_content?k.text_content.length:0,j=(d[y-1]?d[y-1].textCountBefore:0)+T;
k.textCountBefore=j,C=S===e?r:a(S,"width");
var N=r?C/r:0;
.7>=N?k.ad_available=!1:f>j||f>s-j||S.style.height&&S!==e||S.style.maxHeight?k.ad_available=!1:(d.autoAdAvailable=!0,
...
u=i(e),p=n(e);
var d=e.innerHTML;
/float:\s*(right|left)/g.test(d)&&(g=e.style.overflowY,"auto"!==g&&"hidden"!==g&&(e.style.overflowY="hidden"));
var l=e.offsetTop;
...
a.push(c),/float:\s*(right|left)/g.test(d)&&"auto"!==g&&"hidden"!==g&&(e.style.overflowY=g||""),
