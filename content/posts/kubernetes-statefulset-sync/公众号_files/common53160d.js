...
switch(!0){
case 1e3>=n&&n>0:
c.setSum(128961,11,1);
break;

case 2e3>=n&&n>1e3:
c.setSum(128961,12,1);
break;

case 3e3>=n&&n>2e3:
c.setSum(128961,13,1);
break;

case 4e3>=n&&n>3e3:
c.setSum(128961,14,1);
break;

case 5e3>=n&&n>4e3:
c.setSum(128961,15,1);
break;

case 1e4>=n&&n>5e3:
c.setSum(128961,6,1),r(6,s);
break;

case 2e4>=n&&n>1e4:
c.setSum(128961,7,1),r(7,s);
break;

case 3e4>=n&&n>2e4:
c.setSum(128961,8,1),r(8,s);
break;

case 4e4>=n&&n>3e4:
c.setSum(128961,9,1),r(9,s);
break;

case 5e4>=n&&n>4e4:
c.setSum(128961,10,1),r(10,s);
break;

case n>5e4:
c.setSum(128961,37,1),r(11,s);
}
p.mark("appmsg","saveArticleRequestTime","end"),p.saveSpeeds("appmsg","saveArticleRequestTime",48)&&p.send(),
c.send();
}
var t=e("media/common.js"),n=e("common/wx/Tips.js"),i=e("common/wx/Cgi.js"),a=e("resp_types/base_resp.rt.js"),o=e("resp_types/file_cnt.rt.js"),c=e("biz_common/utils/monitor.js"),p=e("common/wx/speedPerformance.js"),u={
del:function(e,r){
i.post({
mask:!1,
...
"0"==e.ret?(n.suc("删除成功"),r&&r(e)):n.err("删除失败");
});
},
del_sv:function(e,r){
i.post({
...
e.base_resp&&0==+e.base_resp.ret?(n.suc("删除成功"),r.suc&&r.suc(e)):(n.err("删除失败"),
r.fail&&r.fail(e));
});
},
...
e.base_resp&&0==+e.base_resp.ret?(n.suc("编辑成功"),r.suc&&r.suc(e)):(n.err("编辑失败"),
r.fail&&r.fail(e));
});
},
save:function(e,r,a,o,u,m){
var f=wx.url(a.AppMsgId?"/cgi-bin/operate_appmsg?t=ajax-response&sub=update&type=%s".sprintf(r):"/cgi-bin/operate_appmsg?t=ajax-response&sub=create&type=%s".sprintf(r));
a.ajax=1;
var d=wx.cgiData,l=d.selfcheck_autocheck,g=d.can_use_selfcheck;
g&&l&&(a.isNeedSave=1);
var _=(new Date).getTime();
p.mark("appmsg","saveArticleRequestTime","start"),i.post({
url:f,
data:a,
dataType:"json",
rtDesc:{
...
error:function(e,r){
"timeout"!=r&&n.err("保存失败"),u&&u(!1,-1,"",{
myErrMsg:"保存失败"
});
},
complete:m
},function(e){
if(s(_,a),"0"==e.ret)n.suc("保存成功"),o&&o(e);else{
var r=t.articleRetCode(e),i=r.index;
e.myErrMsg=r.errmsg,200047===e.base_resp.ret?e.myErrMsg="标题中不能含有特殊字符":202901===e.base_resp.ret&&(e.myErrMsg="直播间卡片数量不能超过3个");
var p="";
e.ret?p=e.ret:e.base_resp&&(p=e.base_resp.ret,-203===Number(p)?(c.setSum(65080,124,1),
c.send()):500201===Number(p)&&(c.setSum(127648,36,1),c.send())),u&&u(i,e.ret,e.remind_wording,e);
}
});
},
preview:function(e,r,s,a,o){
i.post({
...
error:function(){
n.err("发送失败，请稍后重试"),o&&o({
word:"发送失败，请稍后重试"
});
}
},function(e){
if("0"==e.ret)s.only_check||n.suc("发送预览成功，请留意你的手机微信"),a&&a(e);else{
var i=t.articleRetCode(e);
e.word=i.errmsg,e.antispam=i.index,200047===e.base_resp.ret?e.word="标题中不能含有特殊字符":202901===e.base_resp.ret&&(e.word="直播间卡片数量不能超过3个"),
15==r&&n.err(e.word),o&&o(e);
}
});
},
sendPreview:function(e,r,s){
i.post({
...
error:function(){
n.err("发送失败，请稍后重试"),s&&s({
word:"发送失败，请稍后重试"
});
}
},function(i){
if("0"==i.ret)e.only_check||n.suc("发送预览成功，请留意你的手机微信"),r&&r(i);else{
var a=t.articleRetCode(i);
i.word=a.errmsg,i.antispam=a.index,s&&s(i);
}
});
},
modifyPreview:function(e,r,s){
i.post({
...
if("0"==e.ret)n.suc("发送预览成功，请留意你的手机微信"),r&&r(e);else{
var i=t.articleRetCode(e);
e.word=i.errmsg,e.antispam=i.index,15==type&&n.err(e.word),s&&s(e);
}
});
},
getList:function(e,r,s,t,c,p){
var u="";
...
e&&e.base_resp&&0==e.base_resp.ret?t&&t(e.app_msg_info):n.err("获取列表失败");
});
},
getSingleList:function(e,r,s,t){
i.get({
mask:!1,
...
e&&e.base_resp&&0==e.base_resp.ret?(n.suc("保存成功"),r&&r(e)):(n.err("保存失败"),s&&s(e));
});
}
};
return{
...
if(!e||!e.base_resp)return void n.err("重命名失败");
var r=e.base_resp.ret;
if("0"==r)n.suc("重命名成功"),s&&s(e);else switch(r){
case"200002":
n.err("素材名不能包含空格");
break;
...
e&&e.base_resp&&0==e.base_resp.ret?t&&t(e.page_info):n.err("获取列表失败");
});
},
appmsg:u,
vote:m
...
case 64717:
a.errmsg="你所转载的原创文章已被删除，请备份内容后重试";
break;
...
eqWhiteKey:g?g.getCompareWhiteKey():{},
