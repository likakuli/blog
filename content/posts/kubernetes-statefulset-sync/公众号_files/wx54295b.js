...
function s(){
var e=$.ajax(o);
return e.callback=e.done,e.done(function(e){
try{
if(a){
var o=a?a.toString():"",r={
uin:wx.uin||"0",
id:"64430",
key:"0",
url:"",
...
s=this.url.substr(0,this.url.indexOf("?"));
var c=new i(this.url);
"String"==typeof c.get("action")&&(s+="?action="+c.get("action"));
}
window.WX_BJ_REPORT.BadJs.report(s,"ret="+e.base_resp.ret,{
mid:window.PAGE_MID,
view:"web_retcode"
});
}
...
l&&l(r),c.error(r,o,e),d.trigger("xhrError",e,r,t,o);
}).always(function(){
o.mask&&n.hide();
}),e;
}
var a,l;
t&&"object"==("undefined"==typeof t?"undefined":_typeof(t))?(a=t.done,l=t.fail):a=t,
...
var p={},w="function fetch() { [native code] }"===window.fetch.toString();
if(w||((new Image).src="/mp/jsmonitor?idkey=69271_84_1"),window.fetch&&w&&(/cgi-bin\/operate_appmsg\?t=ajax-response&sub=create/.test(o.url)||/cgi-bin\/operate_appmsg\?t=ajax-response&sub=update/.test(o.url)))try{
var f=new FormData;
for(var _ in o.data)Object.prototype.hasOwnProperty.call(o.data,_)&&f.append(_,o.data[_]);
p=r(fetch(o.url,{
method:"POST",
body:f,
credentials:"include"
}),o.timeout).then(function(e){
if(u&&clearTimeout(u),e.ok&&200===e.status)return e.json();
...
var s=r.url;
if(-1!==r.url.indexOf("?")){
s=r.url.substr(0,r.url.indexOf("?"));
var c=new i(r.url);
"String"==typeof c.get("action")&&(s+="?action="+c.get("action"));
}
window.WX_BJ_REPORT.BadJs.report(s,"ret="+e.base_resp.ret,{
...
var r="";
r="string"==typeof e?e:e.statusText,l&&l(r),o.error&&o.error(r),(new Image).src="/mp/jsmonitor?idkey=69271_85_1",
"undefined"!=typeof window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs&&e&&e.stack&&window.WX_BJ_REPORT.BadJs.report("EventError","editor_fetch_save_error",{
mid:window.PAGE_MID,
stack:e.stack
});
}).finally(function(){
u&&clearTimeout(u),o.mask&&n.hide();
});
}catch(g){
(new Image).src="/mp/jsmonitor?idkey=69271_83_1",p=s();
}else p=s();
return p;
}
...
var d=e("common/qq/events.js")(!0),m={
dataType:"json",
mask:!1,
timeout:45e3,
error:$.noop,
