...
title:r,
imageUrl:i
})).attr("data-miniprogram-appid",e).attr("data-miniprogram-path",o).attr("data-miniprogram-nickname",p).attr("data-miniprogram-avatar",m).attr("data-miniprogram-title",r).attr("data-miniprogram-imageUrl",i).attr("data-miniprogram-type",d).attr("data-miniprogram-servicetype",g);
...
var g=n[o];
g.imageUrl&&!p.isLocalDomain(g.imageUrl)&&m.push({
id:"122443",
key:"13"
});
}
...
var p=t("common/wx/mpEditor/plugin/remoteimg.js"),m=(t("common/wx/Tips.js"),t("common/wx/dialog.js")),o=t("common/wx/mpEditor/common/eventbus.js"),d=t("tpl/mpEditor/plugin/link_popup.html.js"),g=t("common/wx/mpEditor/plugin/img.js"),s={
maxCount:50,
maxUniqueCount:10,
convertArr:[]
};
...
if(e=i.findParentByTagName(m,"a",!0),!e&&1==m.nodeType)for(var o,d,g,s=m.getElementsByTagName("a"),c=0;g=s[c++];)if(o=i.getPosition(g,n),
d=i.getPosition(g,p),(o&i.POSITION_FOLLOWING||o&i.POSITION_CONTAINS)&&(d&i.POSITION_PRECEDING||d&i.POSITION_CONTAINS)){
e=g;
break;
}
return e;
...
addListener:function(t){
var a=this;
t.addListener("beforepaste",function(){
if(t&&"function"==typeof t.fireEvent&&s.convertArr.length>0){
for(var a=[],e=0,r=s.convertArr.length;r>e;e++){
a.push({
id:"122443",
key:"12"
});
var i=s.convertArr[e];
i.imageUrl&&!p.isLocalDomain(i.imageUrl)&&a.push({
id:"122443",
key:"13"
});
}
a.length>0&&t.fireEvent("reportAddNum",a);
}
...
n?(s=n,s.url=g.url,s.txt=g.txt,s.needBreak=g.needBreak,s.isWeapp=g.isWeapp):s=g,
r.data.push({
html:wx.T(d,s),
renderData:s,
renderTpl:d,
...
return a.totalCount>s.maxCount||a.uniqueCount>s.maxUniqueCount?(m.show({
width:750,
type:"warn",
msg:"图文中包含的小程序素材不能多于%s个、小程序帐号不能多于%s个".sprintf(s.maxCount,s.maxUniqueCount),
buttons:[{
text:"确定",
click:function(){
this.remove();
...
var t=function(t){
var e=t.getAttr("data-miniprogram-appid")||t.getAttr("data-weapp-appid")||"",r=t.getAttr("data-miniprogram-title")||t.getAttr("data-weapp-title")||"",i=t.getAttr("data-miniprogram-imageUrl")||t.getAttr("data-weapp-imageUrl")||"",n=t.getAttr("data-miniprogram-nickname")||t.getAttr("data-weapp-nickname")||"",p=t.getAttr("data-miniprogram-avatar")||t.getAttr("data-weapp-avatar")||"",m=t.getAttr("data-miniprogram-path")||t.getAttr("data-weapp-path")||"",o=t.getAttr("data-miniprogram-type")||"",d=t.getAttr("data-miniprogram-servicetype")||"0";
s.convertArr.push({
imageUrl:i
});
var g=UE.uNode.createElement("iframe");
t.children.forEach(function(t){
g.appendChild(t);
}),g.setAttr("class","res_iframe weapp_app_iframe js_editor_weapp"),g.setAttr("frameborder","0"),
g.setAttr("src",a("/cgi-bin/readtemplate?t=tmpl/weapp_tmpl&title={title}&imageUrl={imageUrl}&avatar={avatar}&nickname={nickname}",{
nickname:n,
avatar:p,
title:r,
imageUrl:i
})),g.setAttr("data-miniprogram-appid",e),g.setAttr("data-miniprogram-title",r),
g.setAttr("data-miniprogram-imageUrl",i),g.setAttr("data-miniprogram-nickname",n),
g.setAttr("data-miniprogram-avatar",p),g.setAttr("data-miniprogram-path",m),g.setAttr("data-miniprogram-type",o),
g.setAttr("data-miniprogram-servicetype",d),t.parentNode.replaceChild(g,t);
};
return{
"mp-miniprogram":t,
"mp-weapp":t,
...
a&&(a.indexOf("weapp_text_link")>-1||a.indexOf("weapp_image_link")>-1)&&(t.setAttr("href",""),
t.setAttr("_href",""));
},
span:function(t){
var a=t.getAttr("class");
a&&a.indexOf("js_weapp_display_element")>-1&&(console.log(t),t.parentNode.removeChild(t));
}
};
},
...
n=e(n,p);
var d=this.editor,s=d.execCommand("inserthtml",n,!0);
