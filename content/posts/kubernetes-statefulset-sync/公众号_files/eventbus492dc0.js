define("pages/modules/region/region.js",["pages/modules/region/region.tpl.js","pages/modules/utils/cgi.js","vue-weui/src/dropdown/dropdown.js"],function(t,n,i){"use strict"
...
}else"154017"==i||"720005"==i?n.err("请先绑定管理员再进行群发操作"):"64559"==i?n.err("不支持添加未群发的文章链接"):"202605"==i?n.err("帐号付费功能被封禁期间不可群发付费内容"):"202610"==i?n.err("帐号未开通付费功能，不可群发付费内容"):"64717"==i?n.err("你所转载的原创文章已被删除，请备份内容后重试"):"67015"==i||"67024"==i||"67025"==i?n.err("所选视频状态异常，请重新选择或者前往视频素材库查看详情"):"720002"==i?n.err("二维码已过期，请关闭弹窗重试群发"):"720003"==i?n.err("操作繁忙，请刷新页面重试"):"67031"==i?n.err("未审核通过的视频不能被使用"):t.hasnotHandle=!0;
r&&r(t);
});
},
...
});define("common/wx/media/factory.js",["common/wx/media/img.js","common/wx/media/img9.js","common/wx/media/audio.js","common/wx/media/video.js","common/wx/media/appmsg.js","tpl/media/videocard.html.js","tpl/media/appmsg_edit/video_article_content.html.js","common/wx/richEditor/emotionEditor.js","tpl/media/appmsg_edit/text_editor.html.js","tpl/media/appmsg_edit/text_editor_word_tips.html.js","biz_common/utils/load3rdimg.js","common/wx/media/videoUtils.js","common/qq/emoji.js","widget/text_editor.css","common/wx/popover.js","biz_web/lib/store.js","tpl/media/video_title.html.js","common/wx/inputCounter.js","common/wx/Tips.js","common/wx/dialog.js","pages/media/modules/video_status/video_status.js","tpl/media/cardmsg.html.js","common/wx/const.js"],function(e,i,o){
"use strict";
var t=e("common/wx/media/img.js"),d=e("common/wx/media/img9.js"),m=e("common/wx/media/audio.js"),n=e("common/wx/media/video.js"),s=e("common/wx/media/appmsg.js"),r=(e("tpl/media/videocard.html.js"),
e("tpl/media/appmsg_edit/video_article_content.html.js")),l=e("common/wx/richEditor/emotionEditor.js"),a=e("tpl/media/appmsg_edit/text_editor.html.js"),c=e("tpl/media/appmsg_edit/text_editor_word_tips.html.js"),p=e("biz_common/utils/load3rdimg.js"),u=e("common/wx/media/videoUtils.js");
e("common/qq/emoji.js"),e("widget/text_editor.css");
var _=(e("common/wx/popover.js"),e("biz_web/lib/store.js")),h=e("tpl/media/video_title.html.js"),w=e("common/wx/inputCounter.js"),j=(e("common/wx/Tips.js"),
e("common/wx/dialog.js")),v=e("pages/media/modules/video_status/video_status.js"),g=e("tpl/media/cardmsg.html.js"),f=e("common/wx/const.js"),x={
1:function(e,i){
...
10:function(e,i){
return i.container=$(e),i.showMask=!1,new s(i);
},
11:function(e,i){
return i.container=$(e),i.showMask=!1,new s(i);
},
...
!_.get(d)&&i.isMyMpVideo&&(_.set(d,1),j.show({
width:600,
type:"info",
...
title:i.title,
duration:i.duration
}],i.status=v.getVideoStatus(i);
var s=$(e).append('<div data-type="15" class="js_previe_media_box">'+wx.T(r,i)+"</div>");
return $(".js_preview_hd").unbind("click"),$(".js_preview_hd").click(function(){
u.showVideoPreviewDialog({
vid:i.vid,
...
var T={
render:function(e,i){
x[i.type]&&$(e).length>0&&x[i.type]($(e).html(""),i);
},
