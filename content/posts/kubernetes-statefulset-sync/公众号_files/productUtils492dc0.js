...
if(a&&a.templateId){
var r=a.productData;
if(!r&&b.copyIframeProductData[a.datakey]&&(r=b.copyIframeProductData[a.datakey].productData),
r&&r.length>0)if(2==a.type){
...
n(s);
for(var u in l){
var m=new RegExp("\\{\\{"+u+"\\}\\}","g"),f="";
f="undefined"!=typeof s[l[u]]?s[l[u]]:l[u],o=o.replace(m,f);
}
}
var _=$("<div>").html(o),h=1;
return _.find("."+b.appmsgLoopClass).each(function(){
h>d&&$(this).remove(),h++;
}),0==t[0].has_commission&&(_.find(".js_cps_adTag").hide(),_.find(".js_btn_word").text("详情")),
1==t[0].ad_block_status?_.find(".js_cps_check_fail").show():_.find(".js_cps_check_fail").hide(),
"list"==r&&(t[0].category_id==a()||t[0].category_id==e()?(_.find(".js_price").removeClass("show"),
_.find(".js_price").addClass("hide"),_.find(".js_desc").removeClass("hide"),_.find(".js_desc").addClass("show")):(_.find(".js_price").removeClass("hide"),
_.find(".js_price").addClass("show"),_.find(".js_desc").removeClass("show"),_.find(".js_desc").addClass("hide"),
_.find(".js_title").addClass("line2"))),t[0].category_id!=e()&&_.find(".js_product_container").addClass("cps_inner_book"),
_.html();
}
function f(t){
